...
(async () => {
    ...
    {
        const domain = { name: 'entry', version: '1', chainId: chainId, verifyingContract: entry.target };
        const types = {
            SwapETH: [
    ...
    const signedTx = await signer.signTransaction({ ...tx, type: 0, chainId, nonce, gasLimit, gasPrice: 28000000000 });
